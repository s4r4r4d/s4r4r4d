  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center md:hidden py-8">
        ...
        <h2 className="text-2xl font-normal text-text-primary mt-5 leading-tight">
          frontend developer &
        </h2>
        <h2 className="text-2xl font-normal text-text-primary leading-tight">
          product designer
        </h2>
      </div>
      ...
      <div className="hidden md:flex items-center justify-center relative">
        ...
        >
          <h2 className="text-5xl font-semibold text-text-primary mb-2">designer</h2>
          <p className="text-text-primary font-light text-base max-w-xs">
        ...
        <div className="relative w-150 h-150 rounded-lg z-10">
          ...
          <motion.div
            ...
            className="absolute inset-0 transition-opacity duration-100 z-0 w-[400px] h-[400px] top-1/2 left-1/2 -mt-[100px] -ml-[250px]"
          ...
          >
            <motion.div
              className="relative w-full h-full -translate-y-[22px]"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 1, delay: 0.5 }}
            >
        ...
        <motion.div
          ...
          transition={{ duration: 1.5, ease: 'easeOut' }}
        >
          <h2 className="text-5xl font-semibold text-text-primary mb-2">
          ...
          <p className="text-text-primary text-base font-light max-w-xs">
